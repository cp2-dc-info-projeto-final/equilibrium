...
![link_de_cadastro](src/imagens/manual_do_usuario/cadastro_link.png)
...
![encerramento_de_sessao](src/imagens/manual_do_usuario/painel_nav.png)
...
![link_de_edicao](src/imagens/manual_do_usuario/painel_nav.png)
...
![alteracao_de_perfil](src/imagens/manual_do_usuario/altPerfil.png)

## Troca de senha

O usuário também tem a opção de trocar a sua senha. Para isto, ele deve fazer os passos da funcionalidade anterior, contudo, este deve seguir para a seção "Nova senha" embaixo da seção "Alterar perfil". Nesta área, ele deve preencher os campos senha, confirmar senha e clicar no botão “Alterar senha” abaixo da seção. Caso haja alguma exceção, o sistema enviará um aviso de erro ao usuário. Se não houver nenhum erro, o sistema também transportará o usuário para a página com os dados pessoais impressos.

![alteracao_de_senha](src/imagens/manual_do_usuario/altSenha.png)
...
![timeline](src/imagens/manual_do_usuario/timeline_usuario.png)
...
![link_de_admin](src/imagens/manual_do_usuario/painel_nav.png)
...
![gerenciamento_de_cadastro](src/imagens/manual_do_usuario/painelAdm.png)
...
![publicacao_de_post](src/imagens/manual_do_usuario/publicar.png)
...
![exclusao_de_post](src/imagens/manual_do_usuario/post.png)
...
![edicao_de_post](src/imagens/manual_do_usuario/altPost.png)
...
![publicacao_de_comentario](src/imagens/manual_do_usuario/comentarios.png)
...
![exclusao_de_comentario](src/imagens/manual_do_usuario/comentarios.png)
...
![edicao_de_comentario](src/imagens/manual_do_usuario/altComentario.png)
...
![curtida_de_post](src/imagens/manual_do_usuario/curtida_post.png)
...
![curtida_de_comentario](src/imagens/manual_do_usuario/curtida_comentario.png)